...
export default function RegisterScreen() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      const { data, error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: 'fortunai://complete_profile', // Changed to complete_profile
      ...
      const result = await WebBrowser.openAuthSessionAsync(data.url, 'fortunai://complete_profile');
  ...
  /* Temporarily disable Apple Sign-Up
    ...
    <>
      ...
      >
        ...
        <View style={styles.content}>
          ...
          {/* Temporarily disable Apple sign-up button on iOS */}
          {/*
          {Platform.OS === 'ios' && (
            <TouchableOpacity
